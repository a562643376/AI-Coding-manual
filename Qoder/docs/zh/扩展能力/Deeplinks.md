...
Deeplinks 允许您通过简单的 URL 与他人分享 Agentic Chat 提示词、Quest 任务、规则和 MCP 服务器配置。当您点击深链时，IDE 会打开并显示确认对话框，展示即将添加的内容。在您审核并确认前，深链不会自动执行任何操作。
...
| 问题                              | 可能原因              | 解决方案                                                            |
| ------------------------------- | ----------------- | --------------------------------------------------------------- |
| "Unregistered deeplink path"    | 未支持的deeplink path | 请检查深链的 path 是否在上述支持的范围内，并检查 Qoder 版本在 0.2.21 以上                 |
