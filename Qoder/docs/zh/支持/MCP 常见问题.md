...
<div id="failed-to-add-or-install-the-mcp-servers">
  ## **无法添加或安装 MCP（Model Context Protocol）服务**
</div>

<div id="issue-npx-environment-missing">
  ### **问题：缺少 NPX 运行环境**
</div>
...
安装 [Node.js](https://nodejs.org/) V18 或更高版本（内含 NPM V8 及以上）。较早版本可能导致工具运行失败。
...
安装 [nvm-windows](https://github.com/coreybutler/nvm-windows) 以管理多个版本：
...
<div id="issue-uvx-environment-missing">
  ### **问题：缺少 UVX 环境**
</div>
...
<div id="issue-unable-to-initialize-mcp-client">
...
<div id="tool-usage-issues">
  ## **工具使用相关问题**
</div>

<div id="issue-tools-fail-due-to-environment-or-parameter-errors">
  ### **问题：因环境或参数错误导致工具执行失败**
</div>
...
<div id="issue-llm-fails-to-call-mcp-tools">
  ### **问题：LLM 无法调用 MCP 工具**
</div>
...
> <div id="issue-mcp-server-list-fails-to-load">
