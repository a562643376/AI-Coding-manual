...
<div id="common-troubleshooting-methods">
  ### 常见故障排查方法
</div>

<div id="method-1-configure-a-supported-shell">
  #### 方法 1：配置受支持的 shell
</div>
...
<div id="method-2-manually-install-shell-integration">
  #### 方法 2：手动安装 shell 集成
</div>
...
> 如需其他 shell 的配置方法，请参阅 [VS Code 官方文档](https://code.visualstudio.com/docs/terminal/shell-integration#_manual-installation)。

<div id="if-issues-persist">
  ### 如果问题仍然存在
</div>
...
<div id="windows-specific-troubleshooting">
  ### Windows 专属故障排除
</div>
...
1. 从 [https://git-scm.com/downloads/win](https://git-scm.com/downloads/win) 下载并安装 Windows 版 Git。
2. 退出并重新打开 Qoder。
3. 将 Git Bash 设为默认终端：
...
如果版本低于 7，请从 [Microsoft PowerShell 文档](https://learn.microsoft.com/en-us/powershell/scripting/install/installing-powershell-on-windows) 下载并安装。
...
<div id="solution-2-conditional-disable">
...
<div id="solution-1-temp-disable">
  #### 方案二：暂时禁用
</div>
